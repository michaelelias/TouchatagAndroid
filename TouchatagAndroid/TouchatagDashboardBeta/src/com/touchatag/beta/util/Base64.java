...
/**
 * Base 64 utility class.
 * 
 * @author Dann Martens (danny.martens@alcatel-lucent.com/dann@tomoton.com)
 */
public class Base64 {
     ...
     * @since 1.4
     */
    public static String serialize(java.io.Serializable serializableObject) {
        return serialize(serializableObject, NO_OPTIONS);
    } 
     ...
     * @since 2.0
     */
    public static String serialize(java.io.Serializable serializableObject, int options) {
        // Streams
        ...
        try {
            ...
            // GZip?
            if(gzip == GZIP) {
                oos = new ObjectOutputStream(new GZIPOutputStream(b64os) { 
                    /* Initializer */ {
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
        // Example: ====
    	if(source[srcOffset] == EQUALS_SIGN || source[ srcOffset + 1] == EQUALS_SIGN) {
    		return 0;
    	} 
        // Example: Dk==
