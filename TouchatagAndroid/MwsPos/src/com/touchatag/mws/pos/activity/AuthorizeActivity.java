...
public class AuthorizeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				...
				sb.append("	document.getElementById('username').value = '" + settings.getUsername() + "';");
				sb.append("	document.getElementById('password').value = '" + settings.getPassword() + "';");
				sb.append("}");
				sb.append("})()");
	...
	protected void onResume() {
		...
		MwsServer server = ServerInstance.BETA;
	...
	private void onAccessTokenReceived(String key, String secret) {
		settings.setAccessToken(key);
		settings.setAccessTokenSecret(secret);
	...
	private CommonsHttpOAuthProvider getProvider(String serverUrl) {
		...
		String baseUrl = serverUrl + "/rest/oauth";
