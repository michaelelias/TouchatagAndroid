...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		List<Server> servers = serverStore.findAll();
