...
public class TagEventResponseDeserializer {
	...
	public static TagEventFeedback deserialize(String response) {
		...
		try {
			...
			boolean inApplicationResponse = false;
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if (eventType == XmlPullParser.START_DOCUMENT) {
					...
					} else if (inTagEventResponse && !inApplicationResponse && TAG_APPLICATION_RESPONSE.equalsIgnoreCase(startTag)) {
						inApplicationResponse = true;
					...
					} else if (inApplicationResponse && TAG_APPLICATION_RESPONSE.equalsIgnoreCase(xpp.getName())) {
						inApplicationResponse = false;
					}
